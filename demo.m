in interactive mode for a %% Demo to compute P-CNN
...
param.lhandposition=4;
%param.rhandposition=12;
%param.rhandposition=4;
param.rhandposition=6;
%param.upbodypositions=[1 2 3 4 5 6 7 8 9 12 13];
%param.upbodypositions=[2 1 3 6 9 12 4 7 5 8];
param.upbodypositions=[1 2 3 6 5 10 8 7 5 13 12];
...
param.imext = '.jpeg' ; % input image extension type
param.jointpath = '/data/stars/user/sdas/CAD60/newjoint_positions' ; % human pose (one folder per video in which there is a file called 'joint_positions.mat')
param.trainsplitpath = '/data/stars/user/sdas/CAD60/splits/CAD60_train1.txt'; % split paths
param.testsplitpath = '/data/stars/user/sdas/CAD60/splits/CAD60_test1.txt';
...
param.trainsplitpath = '/data/stars/user/sdas/CAD60/splits/CAD60_train2.txt';
param.testsplitpath = '/data/stars/user/sdas/CAD60/splits/CAD60_test2.txt';
compute_pcnn_features(param); % compute P-CNN for split 2

% compute for another split
param.savedir = 'p-cnn_features_split3';
param.trainsplitpath = '/data/stars/user/sdas/CAD60/splits/CAD60_train3.txt';
param.testsplitpath = '/data/stars/user/sdas/CAD60/splits/CAD60_test3.txt';
compute_pcnn_features(param); % compute P-CNN for split 3
% compute for another split
param.savedir = 'p-cnn_features_split4';
param.trainsplitpath = '/data/stars/user/sdas/CAD60/splits/CAD60_train4.txt';
param.testsplitpath = '/data/stars/user/sdas/CAD60/splits/CAD60_test4.txt';
compute_pcnn_features(param); % compute P-CNN for split 4
%}
%{
param.savedir = 'p-cnn_features_split5';
param.trainsplitpath = '/data/stars/user/sdas/MSRDailyActivity3D/splits/train5.txt';
param.testsplitpath = '/data/stars/user/sdas/MSRDailyActivity3D/splits/test5.txt';
